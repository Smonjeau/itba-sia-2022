...
public class PairingTest {
    ...
    public void uniformPairing() {
        ...
        Individual i1 = new Individual(new boolean[]{false, false, true, true, false}, items, 0.1);
        Individual i2 = new Individual(new boolean[]{true, false, false, true, true}, items, 0.1);
